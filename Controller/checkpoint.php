<?php
    ...
    foreach($points as $key => $point) {
      ...
      switch ($ketqua) {
        case 'vertex':
            echo "<div id='stt_check' class='input-group'>
                        ...
                        <input style='height:30px;width:150px;' class='form-control' id='lat' name='lat' placeholder='Nhập giá trị Lat'value='".$postlat."'>
                        <input style='height:30px;width:150px;' class='form-control' id='long' name='long' onBlur='testkh()' placeholder='Nhập giá trị Long' value='".$postlong."' >
                    </div>";
        ...
        case 'outside':
            echo "<div id='stt_check' class='input-group'>
                        ...
                        <input style='height:30px;width:150px;' class='form-control' id='lat' name='lat' placeholder='Nhập  lại giá trị Lat' >
                        <input style='height:30px;width:150px;' class='form-control' id='long' name='long' onBlur='testkh()' placeholder='Nhập lại giá trị Long' >
                    </div>";
