<?php
    ...
    foreach($points as $key => $point) {
      ...
      switch ($ketqua) {
        case 'vertex':
            echo "<div id='stt_check_dd' class='input-group'>
                        ...
                        <input style='height:30px;width:150px;' class='form-control' id='lat_dd' name='lat_dd' placeholder='Nhập giá trị Lat'value='".$postlat."'>
                        <input style='height:30px;width:150px;' class='form-control' id='lon_dd' name='lon_dd' onBlur='testdd()' placeholder='Nhập giá trị Long' value='".$postlong."' >
                    </div>";
        ...
        case 'outside':
            echo "<div id='stt_check_dd' class='input-group'>
                        ...
                        <input style='height:30px;width:150px;' class='form-control' id='lat_dd' name='lat_dd' placeholder='Nhập  lại giá trị Lat' >
                        <input style='height:30px;width:150px;' class='form-control' id='lon_dd' name='lon_dd' onBlur='testdd()' placeholder='Nhập lại giá trị Long' >
                    </div>";
