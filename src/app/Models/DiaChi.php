...
class DiaChi extends Eloquent
{
    ...
    {
        return '<a href="'.route('admin.diachi.show', $this->_id).'" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.view').'" class="btn btn-info"><i class="fas fa-eye"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.diachi.edit', $this->_id).'" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'" class="btn btn-primary"><i class="fas fa-edit"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.diachi.destroy', $this->_id).'"
                data-method="delete"
